...
public class CurrentLevel extends JPanel {
    ...
    public CurrentLevel (){
        ...
        bg.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(bg);
        ...
        avg.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(avg);
        ...
        sk.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(sk);
        ...
        pro.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(pro);
        ...
        lf.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(lf);
        ...
        rf.setFont(new Font("Agency FB",Font.BOLD,18));
        super.add(rf);
